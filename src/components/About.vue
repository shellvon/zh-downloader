<template>
  <el-container>
    <el-aside width="200px">
      <a href="https://github.com/shellvon/zh-downloader" target="_blank">
        <img
    ...
    <el-main>
      <el-row class="plugin-name"
        >知乎下载器
        <span class="plugin-version"> {{ version }} </span>
      </el-row>
      <el-row class="description"
        >这是一个自动嗅探知乎视频资源并且支持直接下载保存的浏览器插件(支持Chrome/Firefox), 使用方式是直接打开知乎网页, 插件会自动嗅探出对应的视频资源提供给用户进行操作.
      </el-row>
      <el-row class="tips">
        如果您在使用过程中有任何疑问,您可以随时在知乎私信给<a class="link" href="https://www.zhihu.com/people/shell-von" target="_blank">
          作者<img src="https://www.lgstatic.com/common/image/social/zhihu@1x.png"
        /></a>
        哦
      </el-row>
      <el-row class="footer">
        <!--Nesting <a> inside <button> doesn't work in Firefox -->
        <a class="link el-button el-button--medium" href="https://github.com/shellvon/zh-downloader" target="_blank">官网</a>
        <a class="link el-button el-button--medium" href="https://github.com/shellvon/zh-downloader/issues/new" target="_blank">问题反馈</a>
      </el-row>
    </el-main>
  </el-container>
</template>
