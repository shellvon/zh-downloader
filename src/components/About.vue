<template>
    <el-container>
        <el-aside width="200px">
            <a href="http://zh-downloader.tw" target="_blank">
        ...
        <el-main>
            ...
            <el-row class="description">这是一个自动嗅探知乎视频资源并且支持直接下载保存的浏览器插件(支持Chrome/Firefox), 使用方式是直接打开知乎网页, 插件会自动嗅探出对应的视频资源用于用户进行操作.
            </el-row>
            <el-row class="warning">
                <span>注意: </span>由于MP4转化相当耗时,因此不建议下载MP4!</el-row>
            <el-row class="footer">
                <!--Nesting <a> inside <button> doesn't work in Firefox -->
                <a class="link el-button el-button--medium" href="http://zh-downloader.tw" target="_blank">官网</a>
